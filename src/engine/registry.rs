...
pub fn builtin_models() -> Vec<ModelDefinition> {
    vec![
        ...
        ModelDefinition {
            ...
            is_directory: true,
            url: "https://huggingface.co/nvidia/parakeet-tdt-0.6b-v2/resolve/main/onnx-int8"
                .to_string(),
            sha256: "".to_string(),
            size_mb: 350,
            accuracy_score: 0.90,
        ...
        ModelDefinition {
            ...
            is_directory: true,
            url: "https://huggingface.co/FunAudioLLM/SenseVoiceSmall/resolve/main/onnx".to_string(),
            sha256: "".to_string(),
            size_mb: 450,
            accuracy_score: 0.82,
            speed_score: 0.70,
