...
```bash
cd /home/brandon/workspaces/github/hass-cortex/cortex-stt
...
# Upload binary
scp target/release/cortex-stt ollama:/opt/cortex-stt/cortex-stt

# Upload web UI
rsync -ah web/dist/ ollama:/opt/cortex-stt/web/dist/

# Start service
ssh ollama "chmod +x /opt/cortex-stt/cortex-stt && sudo systemctl start cortex-stt"
```
