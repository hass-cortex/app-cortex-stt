...
//! engine type, quantization, and filename. We simply check if the file/dir
//! exists on disk and register the corresponding factory.
...
fn create_factory(
    ...
    #[cfg(feature = "onnx")]
    let quantization = match quantization_str {
        "int4" => transcribe_rs::onnx::Quantization::Int4,
        "int8" => transcribe_rs::onnx::Quantization::Int8,
        "fp16" => transcribe_rs::onnx::Quantization::FP16,
        _ => transcribe_rs::onnx::Quantization::FP32,
    };
